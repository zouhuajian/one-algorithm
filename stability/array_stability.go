...
func main() {
	...
	arr := []int{30, 31, 31, 30, 32, 34, 29, 30, 29}
	...
	stabilityThreshold := decimal.NewFromFloat(stabilityScore).Mul(decimal.NewFromFloat(2.0)).InexactFloat64()
